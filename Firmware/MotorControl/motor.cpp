...
bool Motor::setup() {
    ...
    float actual_gain=20.0f;  //actual_gain;   固定放大倍数20倍  共修改3处drv8301，第1处 loop222.6-1
    ...
    //if (!gate_driver_.init())  //共修改3处drv8301，第2处 loop222.6-2
    //    return false;
...
bool Motor::do_checks(uint32_t timestamp) {
    //gate_driver_.do_checks();  共修改3处drv8301，第3处 loop222.6-3
