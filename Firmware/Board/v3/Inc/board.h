...
#else
#define SHUNT_RESISTANCE (1000e-6f)  //(500e-6f)   //根据实际阻值修改  loop222.2  
#endif
...
#define TIM1_INIT_COUNT (TIM_1_8_PERIOD_CLOCKS / 2 - 1 * 512) // 128  相位差，跟电路设计相关，不同电路参数不同  loop222.4
...
#define VBUS_S_DIVIDER_RATIO 18.73f  //19.0f  39K和2.2K组合  loop222.3
